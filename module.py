...
class Module(module.ModuleModel):
    ...
    def _init_auth_processor(self, auth_ctx):
        ...
        try:
            ...
            self.context.rpc_manager.call.auth_update_user(
                id_=user_id, name=user_provider_id, last_login=datetime.now())
        except:
            log.info(f"User already exists")
            self.context.rpc_manager.call.auth_update_user(id_=user_id, last_login=datetime.now())
